...
describe("Inventario", () => {
  ...
  describe("estadoDB", () => {
    ...
    test("debería retornar false si la base de datos no está bien estructurada", () => {
      db.data = {
        bienes: [{ id: 21, nombre: "Espada de Plata de Kaer Morhen", descripcion: "Una reliquia forjada en la fortaleza bruja", material: "Acero de Mahakam", peso: "3", valor: 800 }], // peso no es number
        clientes: [],
        mercaderes: [],
        transacciones: [],
      };
